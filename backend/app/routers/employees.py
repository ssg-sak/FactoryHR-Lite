...
def post_employee(payload: EmployeeCreate, db: DbSession) -> dict[str, object]:
...
def get_employee(employee_id: int, db: DbSession) -> dict[str, object]:
    return employee_service.employee_response(
...
def patch_employee(
    employee_id: int, payload: EmployeeUpdate, db: DbSession
) -> dict[str, object]:
    return employee_service.employee_response(
...
def remove_employee(employee_id: int, db: DbSession) -> Response:
